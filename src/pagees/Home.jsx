  ...
  return (
    <div className=" px-6 max-w-screen-2xl mx-auto">
      ...
      <section className="mt-20 ">
        ...
        <Link to='/products'><main className="gap-8 md:gap-16 grid grid-cols-1 sm:grid-cols-2 mt-10  px-8   ">
          <NFTCard />
      ...
      <section className="mt-20">
        ...
        <main className="  flex flex-col gap-8 max-w-screen-md mx-auto  mt-10 pb-36   ">
      ...
      {/*<section className="mt-20 -mx-6">
        <div className="relative w-full border   mx-auto h-[806px]">
          <img
            className="h-[806px] w-screen relative object-cover"
            alt="contactBg"
            src={contactBg}
          />
      ...
      <section className="bg-[#F5EEE9] -mx-6 p-6 md:p-16 ">
        <p className="font-bold text-xl md:text-2xl text-center mb-6 md:mb-12">
